...
熵 的意思：衡量我们这个世界中事物混乱程度的一个指标，热力学第二定律中认为孤立系统总是存在从高有序度转变成低有序度的趋势，这就是熵增的原理。
熵增与我们正常认为的方向是相反的，比如汽油燃烧，或者电能消耗等都是熵增的行为，从有序的能源，一部分转成了我们所需要的机械能，另一部分则转换成了再也无法利用废热散发到空中，获得了热能的空气或者其他物体，熵会减小....但随着这些热量的散失，逐渐增加并且处于稳定状态！
*/
